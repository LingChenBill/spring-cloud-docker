...
//        return this.restTemplate.getForObject(this.userServiceUrl + id, User.class);
        ...
        return this.restTemplate.getForObject("http://micro-simple-provider-user/" + id, User.class);
    }
    ...
    public void logUserInstance() {
        ServiceInstance serviceInstance = this.loadBalancerClient.choose("micro-simple-provider-user");
